...
<script type="text/javascript">
    ...
    function fn_save(gb) {
        ...
        if (confirm("정말 " + str + "하시겠습니까?")) {
            $.ajax({
                url : "${pageContext.request.contextPath}/pda/product/wheelSave",
                type : "POST",
                ...
                success : function(data) {
                    if(data == "success") {
                        ...
                        //등록, 삭제 시
                            ...
                            location.href = "${pageContext.request.contextPath}/pda/product/wheelList";
                        }
                    }
                    else {
            ...
            <!-- <h3>WHEEL</h3> -->
                <form id="writeForm" name="writeForm" method="post" enctype="multipart/form-data">
                  ...
                  <div class="btn_c">
                      ...
                      <button type="button" class="btn btn-list" onclick="location.href='${pageContext.request.contextPath}/pda/product/wheelList'">목록</button>
                  </div>
              </form>
