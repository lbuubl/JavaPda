...
function fn_loadYearList(){
	...
	t_1 = $(t1_Id).DataTable({
		...
		,"serverSide" : true
		,"ajax": {
			//"url": "/Module/UserModule/OrderPlanMng/json/getDataTable_yearList.do",
			"url": "/module/usermodule/orderplanmng/json/getdatatableYearlist",
			"type": "POST"
		}
		...
		,"infoCallback": function( settings, start, end, max, total, pre ) {
			...
			$(t1_Id+"_wrapper img").each(function(){
			   $(this).error(function(){
				 //$(this).attr('src', '/Module/assets/images/placeholder.jpg');
