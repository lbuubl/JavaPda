...
function makeDataTable(){
	...
	// Table setup
			...
			t1 = $(t1_Id).DataTable({
				...
				//,"bDestroy": true
				,"ajax" : {
					//"url" :"/Module/UserModule/approval/appList/json/getSendedList.do"
					"url" :"/module/usermodule/approval/applist/getSendedList"
					,"type" : "post"
					,"data" : function ( d ) {  // param 미사용 , ASP 로직 유지
						d.mc = mc;
						d.ty = $("#ty").val();
						d.appState = $("#sch_appState").val();
					}
