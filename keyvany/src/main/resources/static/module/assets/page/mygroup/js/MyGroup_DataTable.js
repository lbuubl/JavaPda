...
function makeDataTable(){
	...
	// ------------------------------------------------------------
		$.extend( $.fn.dataTable.defaults, {
			...
			"dom": '<"datatable-header"B><"datatable-scroll"t><"datatable-footer"ip>',
			"language": {
				//데이터 없는 경우
	...
	// Table setup
			...
			t1 = $(t1_Id).DataTable({
				...
				,"ajax" : {
					...
					//"url" :"/Module/UserModule/MyGroup/GroupList.do"
					"url" :"/module/usermodule/mygroup/grouplist"
					,"type" : "post"
				}
				,"pagingType": "simple"
