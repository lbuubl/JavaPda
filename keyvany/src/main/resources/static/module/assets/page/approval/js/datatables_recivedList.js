...
function makeDataTable(){
	...
	// Table setup
			...
			t1 = $(t1_Id).DataTable({
				...
				//,"bDestroy": true
				,"ajax" : {
					//"url" :"/Module/UserModule/approval/appList/json/getRecivedList.do"
					"url" :"/module/usermodule/approval/applist/getRecivedList"
					,"type" : "post"
					,"data" : function ( d ) { // param > appState 만 사용  , ASP 로직 유지
						d.mc = mc;
						d.ty = $("#ty").val();
