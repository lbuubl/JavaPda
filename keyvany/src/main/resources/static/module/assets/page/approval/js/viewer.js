...
function configure(PDFJS) {
  ...
  //PDFJS.imageResourcesPath = '/Module/assets/js/plugins/pdfjs-1.8.170-dist/web/images/';
  //PDFJS.workerSrc = '/Module/assets/js/plugins/pdfjs-1.8.170-dist/build/pdf.worker.js';
  //PDFJS.cMapUrl = '/Module/assets/js/plugins/pdfjs-1.8.170-dist/web/cmaps/';
  PDFJS.imageResourcesPath = '/resources/module/assets/js/plugins/pdfjs-1.8.170-dist/web/images/';
  PDFJS.workerSrc = '/resources/module/assets/js/plugins/pdfjs-1.8.170-dist/build/pdf.worker.js';
  PDFJS.cMapUrl = '/resources/module/assets/js/plugins/pdfjs-1.8.170-dist/web/cmaps/';
...
var PDFViewerApplication = {
  ...
  error: function pdfViewError(message, moreInfo) {
    ...
    lessInfoButton.onclick = function (e) {
		e.preventDefault();
...
function webViewerInitialized() {
  ...
  appConfig.sidebar.toggleButton.addEventListener('click', function (e) {
	e.preventDefault();
...
function ensureOverlay() {
  if (!overlayPromise) {
    ...
    document.getElementById('printCancel').onclick = function(e){
		e.preventDefault();
		abort();
	}
  }
...
var PDFFindBar = function PDFFindBarClosure() {
  function PDFFindBar(options) {
    ...
    this.findPreviousButton.addEventListener('click', function (e) {
	  e.preventDefault();
      self.dispatchEvent('again', true);
    });
    this.findNextButton.addEventListener('click', function (e) {
	  e.preventDefault();
      self.dispatchEvent('again', false);
    });
    this.highlightAll.addEventListener('click', function (e) {
	  e.preventDefault();
      self.dispatchEvent('highlightallchange');
    });
    this.caseSensitive.addEventListener('click', function (e) {
	  e.preventDefault();
...
var PDFSidebar = function PDFSidebarClosure() {
  ...
  PDFSidebar.prototype = {
    ...
    _addEventListeners: function PDFSidebar_addEventListeners() {
      ...
      self.thumbnailButton.addEventListener('click', function (e) {
		e.preventDefault();
        self.switchView(SidebarView.THUMBS);
      });
      self.outlineButton.addEventListener('click', function (e) {
		e.preventDefault();
        self.switchView(SidebarView.OUTLINE);
      });
      self.outlineButton.addEventListener('dblclick', function (e) {
		e.preventDefault();
        self.pdfOutlineViewer.toggleOutlineTree();
      });
      self.attachmentsButton.addEventListener('click', function (e) {
		e.preventDefault();
...
var PDFThumbnailView = function PDFThumbnailViewClosure() {
  ...
  function PDFThumbnailView(options) {
    ...
    anchor.onclick = function stopNavigation(e) {
	  e.preventDefault();
      linkService.page = id;
      return false;
    };
...
var Toolbar = function ToolbarClosure() {
  ...
  Toolbar.prototype = {
    ...
    _bindListeners: function Toolbar_bindClickListeners() {
      ...
      var self = this;
      var items = this.items;
      items.previous.addEventListener('click', function (e) {
  	    e.preventDefault();
        eventBus.dispatch('previouspage');
      });
      items.next.addEventListener('click', function (e) {
		e.preventDefault();
        eventBus.dispatch('nextpage');
      });
      items.zoomIn.addEventListener('click', function (e) {
  	    e.preventDefault();
        eventBus.dispatch('zoomin');
      });
      items.zoomOut.addEventListener('click', function (e) {
		e.preventDefault();
        eventBus.dispatch('zoomout');
      });
      items.pageNumber.addEventListener('click', function (e) {
  	    e.preventDefault();
        this.select();
      });
      items.pageNumber.addEventListener('change', function (e) {
		e.preventDefault();
      ...
      items.scaleSelect.addEventListener('change', function (e) {
...
//var DEFAULT_URL = '/module/usermodule/approval/common/pdf.do?fsn='+fsn;
var DEFAULT_URL = '/module/usermodule/approval/common/pdf?fsn='+fsn;
