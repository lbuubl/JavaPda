...
function makeDataTable(){
	...
	// Table setup
			...
			t1 = $(t1_Id).DataTable({
				...
				//,"bDestroy": true
				,"ajax" : {
					//"url" :"/Module/UserModule/approval/appList/json/getMenuApprovalList.do"
					"url" :"/module/usermodule/approval/applist/getMenuApprovalList"
					,"type" : "post"
					,"data" : function ( d ) {
						d.mc = mc;
						d.ty = $("#ty").val();
						d.appState = $("#sch_appState").val();	//결재상태 조건
						d.configForm = $("#configForm").val();	//양식 일련번호
					}
