...
$(document).ready(function() {
	var config = {
		...
		baseUrl: '/community/companyPds/config/' + $('div.data_room').attr('data-gongguseqno'),
		loadConfig: function() {
			var _this = this;
	...
	var tree = {
		...
		selectNode: null,
		el: $('#tree_list'),
		baseUrl: '/community/companyPds/classinfo',
		tabIndex: 0,
		// 트리 조회
		loadTree: function() {
			var _this = this;
	...
	var initTab = function(treeData) {
		var loader = new UI.LazyLoader('js');
		loader.get('community/companyPds.rename.js', 'community/companyPds.move.js', 'community/companyPds.view.js').then(function(editor, selector, viewer) {
	...
	var leftTab = {
		...
		init: function(classSeqno, tabTitle, titleEditor, folderSelector, viewer) {
			...
			var loader = new UI.LazyLoader('js');
			loader.get('community/companyPds.tab.js').then(function(tab) {
