...
$(function() {
	 // Events
	 $("#uploadEvent_fieldWorkEval").pluploadQueue({
        ...
        init: {
            ...
            BeforeUpload: function(up, file) {
				...
				uploader.settings.multipart_params = {
					"mc" : $("#frmEvaluationEdit input[name='mc']").val(),
					"mst" : $("#frmEvaluationEdit input[name='mst']").val(),
					"FK1" : $("#frmEvaluationEdit input[name='FK1']").val()
				};
            },
	...
	/* 사용자 커스텀 업로드 시작버튼 */
	var uploader = new $("#uploadEvent_fieldWorkEval").pluploadQueue();

	$('#btn_evaluationSave').unbind('click');
	$('#btn_evaluationSave').click(function(e) {
	...
	document.getElementById('uploadEvent_fieldWorkEval').addEventListener('drop', function(e) {
