...
$(function() {
	 // Events
	 $("#uploadEvent_workReq").pluploadQueue({
        ...
        init: {
            ...
            BeforeUpload: function(up, file) {
				...
				uploader.settings.multipart_params = {
					"Size" : "",
					"mc" : $("#frmWorkReqEdit input[name='mc']").val(),
					"mst" : $("#frmWorkReqEdit input[name='MST']").val(),
					"fk1" : $("#frmWorkReqEdit input[name='FK1']").val(),
					"fk2" : "",
					"fk3" : "",
					"Rev" : "",
					"Ak" : ""
            ...
            UploadComplete: function(up, files) {
				...
				$("#workReq_contents").val( tinymce.activeEditor.getContent({format : 'raw'}) );
				var param = $("#frmWorkReqEdit").serialize();
				param += "&i18next_language="+geti18language()
				...
				$.ajax({
					...
					, success:function( data ){
						...
						//console.log('workReqEditDml : ' + JSON.stringify(data));
						if(data.result == "success"){
							...
							//alert('workReqEditDml sn : ' + data.sn);

							//loadTaskList();				//리스트페이지로 이동
							loadWorkReqDetail(data.sn)		//상세페이지로 이동
							$(window).scrollTop(0);
	...
	var uploader = new $("#uploadEvent_workReq").pluploadQueue();
