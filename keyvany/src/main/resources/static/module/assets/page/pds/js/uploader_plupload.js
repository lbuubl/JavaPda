...
//actionUrl = "/Module/UserModule/pds/pdsUploadDml.do"
//uploadUrl = "/common/Pupload_Dml.do"
actionUrl = "/module/usermodule/pds/pdsUploadDml"
		...
		*/
        ...
        init: {
            ...
            BeforeUpload: function(up, file) {
				...
				*/
				uploader.settings.multipart_params = param;
            },
            ...
            UploadComplete: function(up, files) {
				...
				$.ajax({
					type :'get'											// Post로 데이터 전달(get,post방식)
					, asyn : false										// 비동기식으로 ajax 요청
					//, url: "/Module/UserModule/pds/pdsUploadDml.do"		// 전송할 페이지
					, url: actionUrl
					, data : {											// parameter
						"pdsMode" : $("input:radio[name='pdsMode']:checked").val(),
						"mst" : $("#folderSn").val(),
						"SSID" : $("#SSID").val(),
						"title" : $("#pdsUploadTitle").val(),
						"tags" : $("#tags").val(),
						"authObsCodes" : $("#frmUpload input[name='authUserObsCode']").val(),
						"contents" : $("#frmUpload textarea[name='contents']").val()
					}
					, dataType:"json"
					, success:function( data ){
						if(data.result == "success"){
							$.unblockUI();							//block-ui hide
							$('#modal_upload').modal('hide');		//레이어 닫기
