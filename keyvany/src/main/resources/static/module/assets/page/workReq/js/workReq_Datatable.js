...
* ---------------------------------------------------------------------------- */
var t1;
var t1_Id = "#datatable_workReqList";
...
var clickFlag = true;
	...
	// Table setup
			...
			t1 = $(t1_Id).DataTable({
				...
				,"serverSide" : true
				,"ajax" : {
					//"url" :"/Module/UserModule/WorkReq/json/getWorkReqList.do"
					"url" :"/module/usermodule/workreq/getWorkReqList"
					,"type" : "post"
					,"data" : function(d){
						d.sch_gubun = $("#sch_gubun").val();
						d.sch_endYn = $("#sch_endYn").val();
					}
				}
				...
				,"initComplete": function(settings, json) {
					listSize=$("#datatable_workReqList_info");
					$("#datatable_workReqList_length").insertBefore(listSize);

					$(t1_Id+"_filter").append($('#workReqListPanel .multi-select'));
					$('#workReqListPanel .multi-select').show();
