		...
		t1 = $(t1_Id).DataTable({
			...
			,"columnDefs": [  //컬럼 옵션 : 사용자 기호에 맞게 수정

				{
					...
					"className" : " dt-header-center FixColnum"
				}  , {
					"targets": [idx++],
			...
			, "infoCallback": function( settings, start, end, max, total, pre ) {
				...
				t1.column(3, {search:'applied', order:'applied'}).nodes().each( function (cell, i) {
					//console.log(total,i,start+1);
					cell.innerHTML = "<span  title='"+cell.innerHTML+"'>"+cell.innerHTML+"</span>";
				});
			...
			var html = "" ;
			html = html + " <select class='searchStat form-control '> ";
			html = html + "<option value=''  data-i18n='projectMaps:label.all'></option>";
			html = html + "<option value='1' data-i18n='projectMaps:label.open'></option>"
			html = html + "<option value='0' data-i18n='projectMaps:label.close'></option>	</select>"
