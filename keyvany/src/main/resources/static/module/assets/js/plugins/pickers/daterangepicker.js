...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            options.template = '<div class="daterangepicker dropdown-menu '+options.UserClass+'">' +
                '<div class="calendars">' +
        ...
        if (typeof options.dontCloseAfterPick === 'boolean') {
            this.dontCloseAfterPick = options.dontCloseAfterPick;
        }
    ...
    DateRangePicker.prototype = {
        ...
        hide: function(e) {
			...
			/*
            if (!this.startDate.isSame(this.oldStartDate) || !this.endDate.isSame(this.oldEndDate) || (e !="outside" && this.dontCloseAfterPick)	){
				this.callback(this.startDate, this.endDate, this.chosenLabel);
			}
			*/
			if(this.dontCloseAfterPick){
				if(e !="outside"){
					this.callback(this.startDate, this.endDate, this.chosenLabel);
				}
			}else{
			...
			if(! this.dontCloseAfterPick){	//close option add, 2017-03-06, 김영식
