        ...
        preinit: {
            ...
            Init: function(up, info) {
               // log('[Init]', 'Info:', info, 'Features:', up.features);
		     	/*
				$('.plupload_togle').on('click', function() {
						$('.plupload_container').slideToggle('fast', function(i){
								if($(".plupload_container").is(":hidden"))
								{
									$('.plupload_togle img').attr("src", "/Module/assets/images/file_closed.gif");
								}else{
									$('.plupload_togle img').attr("src", "/Module/assets/images/file_opened.gif");
								}
						});
				});
				*/
