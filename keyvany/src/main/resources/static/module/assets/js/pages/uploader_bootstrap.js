...
$(function() {
	...
	mc=$("#mc").val();
	Size=$("#Size").val();
	prm_str="mc^"+mc+"!Size^"+Size;

    $(".file-input-ajax").fileinput({
        uploadUrl: "/Common/upload_Dml.do?mc="+mc+"&Size="+Size, // server upload action
		uploadAsync: true,
        maxFileCount: 0,
        initialPreview: [],
        fileActionSettings: {
		...
		var reader = data.reader;
			console.log('File uploaded response : '+ response.key +"//" + response.filename);
	});
