            ...
            <div class="modal-body">
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-08">
                            <input type="input" class="form-control" id="shFacCd" name="shFacCd"
                                   placeholder="">
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-05">
                                <input type="input" class="form-control" id="shFacNm" name="shFacNm"
                                       placeholder="">
                            </div>
                            <div class="col-sm-01">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" id="modelClose" class="btn btn-default"
