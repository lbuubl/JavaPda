...
import com.hanin.pda.common.interceptor.ProjectListInterceptorAdapter;
import com.hanin.pda.common.interceptor.UserInfoInterceptorAdapter;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        .addPathPatterns("/**")
        .excludePathPatterns("/static/**","/resources/**","/pda/**");
        //관리자쪽 인터셉터
        registry.addInterceptor(userInfoInterceptorAdapter())
        .addPathPatterns("/pda/**")
        .excludePathPatterns("/static/**","/resources/**","/user/**","/headerIndex","/pda/login","/pda/loginAction");
        */
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/resources/static/upload/**","/pda/manage/popImageUpload")
